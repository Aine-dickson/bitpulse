  ...
  // -----------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      },
      {
        ...
        multiplyBy: 'cameras',
        default: '4mp',
        help: 'Higher resolution means you can actually read a face or a plate, and it costs more storage.',
        choices: [
          { id: '2mp', label: '2MP (1080p)', price: 150_000, note: 'General coverage' },
          { id: '4mp', label: '4MP (2K)', price: 235_000, note: 'Recognisable faces' },
          { id: '8mp', label: '8MP (4K)', price: 420_000, note: 'Plates and detail' },
        ],
      },
      {
        id: 'housing',
      ...
      },
      {
        ...
        choices: [
          { id: 'nvr4', label: '4-channel PoE NVR', price: 480_000, capacity: { field: 'cameras', max: 4 } },
          { id: 'nvr8', label: '8-channel PoE NVR', price: 780_000, capacity: { field: 'cameras', max: 8 } },
          { id: 'nvr16', label: '16-channel PoE NVR', price: 1_450_000, capacity: { field: 'cameras', max: 16 } },
          { id: 'nvr32', label: '32-channel NVR', price: 2_700_000, capacity: { field: 'cameras', max: 32 } },
        ],
      },
      {
        id: 'storage',
        ...
        choices: [
          { id: '1tb', label: '1TB surveillance drive', price: 330_000, note: 'approx. 1 to 2 weeks' },
          { id: '2tb', label: '2TB surveillance drive', price: 540_000, note: 'approx. 2 to 4 weeks' },
          { id: '4tb', label: '4TB surveillance drive', price: 950_000, note: 'approx. 1 to 2 months' },
          { id: '6tb', label: '6TB surveillance drive', price: 1_350_000, note: 'approx. 2 to 3 months' },
        ],
      },
      {
        id: 'switch',
        ...
        price: 380_000,
        default: false,
        help: 'Needed when cameras sit further out than the recorder can power directly.',
      },
      {
        id: 'ups',
    ...
    notes: [
      ...
      'Storage estimates assume continuous recording. Motion-only recording lasts considerably longer.',
    ],
  },
  ...
  // -----------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      },
      {
        ...
        default: 'indoor5',
        choices: [
          { id: 'indoor5', label: 'Indoor ceiling AP (WiFi 5)', price: 290_000, note: 'Classrooms, offices' },
          { id: 'indoor6', label: 'Indoor ceiling AP (WiFi 6)', price: 470_000, note: 'Denser, faster' },
          { id: 'outdoor', label: 'Outdoor / long-range AP', price: 520_000, note: 'Yards, between blocks' },
        ],
      },
      {
        id: 'gateway',
        ...
        choices: [
          { id: 'hex', label: 'MikroTik hEX router', price: 260_000, note: 'Up to ~50 users' },
          { id: 'hapax', label: 'MikroTik hAP ax²', price: 420_000, note: 'Up to ~100 users' },
          { id: 'rb4011', label: 'MikroTik RB4011 / CCR', price: 1_450_000, note: '200+ users' },
        ],
      },
      {
        id: 'poe',
        ...
        kind: 'choice',
        default: 'poe8',
        help: 'Powers the access points over the same cable that carries their data.',
        choices: [
          { id: 'poe8', label: '8-port PoE switch', price: 380_000, capacity: { field: 'aps', max: 8 } },
          { id: 'poe16', label: '16-port PoE switch', price: 790_000, capacity: { field: 'aps', max: 16 } },
          { id: 'poe24', label: '24-port PoE switch', price: 1_350_000, capacity: { field: 'aps', max: 24 } },
        ],
      },
      {
        id: 'portal',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      },
      {
        ...
        default: 'indoor5',
        choices: [
          { id: 'indoor5', label: 'Indoor ceiling AP (WiFi 5)', price: 290_000 },
          { id: 'indoor6', label: 'Indoor ceiling AP (WiFi 6)', price: 470_000 },
          { id: 'outdoor', label: 'Outdoor / long-range AP', price: 520_000 },
        ],
      },
      {
        id: 'router',
        ...
        choices: [
          { id: 'hex', label: 'MikroTik hEX', price: 260_000, note: 'Up to ~50 users' },
          { id: 'hapax', label: 'MikroTik hAP ax²', price: 420_000, note: 'Up to ~100 users' },
          { id: 'rb4011', label: 'MikroTik RB4011 / CCR', price: 1_450_000, note: '200+ users' },
        ],
      },
      {
        ...
        default: 'branded',
        choices: [
          { id: 'vouchers', label: 'Printed voucher codes only', price: 350_000, note: 'Sell codes at the counter' },
          { id: 'branded', label: 'Voucher codes + login page in your name', price: 750_000, note: 'Your brand on the page' },
          { id: 'momo', label: 'Mobile money self-service', price: 1_600_000, note: 'Users buy without you' },
        ],
      },
      {
        id: 'training',
    ...
    fields: [
      ...
      },
      {
        ...
        choices: [
          ...
          { id: 'refurb', label: 'Refurbished thin client', price: 420_000 },
          { id: 'new', label: 'New thin client', price: 680_000 },
        ],
      },
      {
        id: 'monitor',
        ...
        choices: [
          ...
          { id: 'r19', label: '19" refurbished', price: 260_000 },
          { id: 'n22', label: '22" new', price: 420_000 },
        ],
      },
      {
        id: 'server',
    ...
    fields: [
      ...
      },
      {
        ...
        choices: [
          ...
          { id: 'refurb', label: 'Refurbished desktop (i5, 8GB, SSD)', price: 1_250_000 },
          { id: 'mini', label: 'Mini PC (i5, 8GB, SSD)', price: 1_650_000 },
          { id: 'new', label: 'New desktop (i5, 8GB, SSD)', price: 2_400_000 },
        ],
      },
      {
        id: 'monitor',
...
export interface KitQuote {
  ...
  total: number
  /** Hardware limits the current configuration breaks. */
  warnings: string[]
    ...
    if (f.kind === 'choice') {
      ...
      if (chosen.capacity) {
        ...
        if (have > chosen.capacity.max) {
          warnings.push(
            `${chosen.label} supports up to ${chosen.capacity.max}. You have ${have}, so pick a larger option.`,
          )
        }
      }
