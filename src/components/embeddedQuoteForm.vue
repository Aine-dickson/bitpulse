        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Request a Quote – Embedded & IoT Development
                </h3>
            ...
            <form @submit="submitForm">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project Type</label>
                        <select v-model="form.projectType" id="project" class="input bg-gray-800 focus:ring-orange-500 focus:border-orange-500" required>
                            <option disabled value="">Select a project type</option>
                            <option value="sensorSystem">Sensor-based System</option>
                            <option value="homeAutomattion">Home Automation</option>
                            <option value="industrial">Industrial Monitoring</option>
                            <option value="custom">Custom Controller</option>
                            <option value="other">Other</option>
                        </select>
                    </div>
                    <div>
                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Do you already have hardware selected?</label>
                        <select v-model="form.hasHardware" id="project" class="input bg-gray-800 focus:ring-orange-500 focus:border-orange-500" required>
                            <option disabled value="">Select one</option>
                            <option>Yes – Finalized</option>
                            <option>Yes – Considering Options</option>
                ...
                <p v-if="submitted" class="text-green-600 mt-4">✅ Thank you! We’ve received your request and will reach out shortly with a quote or follow-up questions.</p>
            </form>
        </div>
    </section>
