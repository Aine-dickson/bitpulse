    ...
    <div class="py-10">
        ...
        <div class="text-lg space-y-3 mb-4">
            ...
            <ul class="list-disc pl-10 space-y-2">
                ...
                <li>
                    <span class="font-bold">Medical equipment that sits unused</span> due to lack of power or technical support
                </li>
                <li>
                    <span class="font-bold">Farming systems stuck in guesswork</span>, not sensors
                </li>
                <li>
                    <span class="font-bold">Small manufacturers unable to scale</span>, relying on hand tools
                </li>
                <li>
                    <span class="font-bold">Unreliable energy</span> that makes “24/7 uptime” a joke, not a goal
                </li>
            </ul>
        </div>

        <p class="text-lg">
            These aren’t software problems. These are <span>systems problems</span>. And if we keep trying to solve them with web dashboards and mobile apps alone, we’ll be stuck in a loop of shiny, shallow progress.
        </p>

        <blockquote class="p-4 my-4 border-s-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
            <p class="text-lg italic leading-relaxed text-gray-900 dark:text-white">“What Africa needs is not more code. What Africa needs is <span class="font-bold">context-aware, infrastructure-grade tech</span> built by Africans who know the terrain, the people, and the constraints.”</p>
        </blockquote>

        <hr class="text-gray-300 dark:text-gray-800 my-12" />

        <section class="text-lg space-y-3 mb-6">
            <h2 class="text-2xl font-semibold mb-4">
                ⚙️ What We Actually Need
            </h2>
            <p>
                It’s time to expand our tech imagination.
            </p>
            <p>
                Here’s what the next phase of African tech must prioritize:
            </p>
            <ul class="space-y-6">
                <li>
        ...
        <div class="text-lg space-y-3 mb-6">
            ...
            <p>
                Real change will require <span class="font-bold">cross-disciplinary collaboration</span>.
            </p>
            <ul class="list-disc pl-10 space-y-2">
                <li>
                ...
                <li>
                    <span class="font-bold">Developers</span> must go beyond React tutorials and GitHub stars. We must get our hands dirty with <span class="font-bold">real-world problems</span>.
                </li>
            </ul>
        </div>

        <blockquote class="p-4 my-4 border-s-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
            <p class="text-lg italic font-medium leading-relaxed text-gray-900 dark:text-white">“The smartest AI model won’t fix a traffic jam. A well-placed sensor and a locally trained control unit might.”</p>
        </blockquote>
        ...
        <div class="text-lg space-y-3 mb-6">
            ...
            <p class="font-bold">
                African innovation must go deep. It must touch metal, power, timing, temperature, and truth.
            </p>
        </div>
        ...
        <blockquote class="p-4 my-4 border-s-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
            <p class="text-lg italic font-medium leading-relaxed text-gray-900 dark:text-white">Let’s stop building for trends. Let’s build for needs.</p>
        </blockquote>
        ...
        <ul class="list-disc pl-10 space-y-2 mb-6 text-lg">
            ...
            <li>
                Stay tuned: We’re about to open-source our first system prototypes
            </li>
        </ul>
