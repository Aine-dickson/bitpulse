            ...
            <form @submit="submitForm">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select v-model="form.sessionType" id="project" class="input bg-gray-800 focus:ring-orange-500 focus:border-orange-500" required>
                            <option disabled value="">Select a session type</option>
                            <option value="oneOnone">One-on-One Mentorship</option>
                            <option value="team">Team Workshop</option>
                            <option value="liveCodeReview">Live Code Review</option>
                            <option value="careerGuidance">Career Guidance</option>
                        </select>
                    </div>
                    <div>
                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Skill level</label>
                        <select v-model="form.level" id="project" class="input bg-gray-800 focus:ring-orange-500 focus:border-orange-500" required>
                            <option disabled value="">Choose your skill level</option>
                    ...
                    <div class="sm:col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Additional Notes (optional)</label>
                        <textarea v-model="form.notes" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="Briefly describe what you’re trying to achieve..."></textarea>                    
                    </div>

                    <div class="sm:col-span-2">
                        <label for="timeline" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Preferred Schedule</label>
                        <input v-model="form.schedule" type="text" name="timeline" id="timeline" class="input focus:ring-orange-600 focus:border-orange-600" placeholder="e.g., Weekends, weekday evenings..." required="">
                    </div>
                </div>
                ...
                <p v-if="submitted" class="text-green-600 mt-4">🎉 Your session request has been submitted. We'll get back to you shortly.</p>
            </form>
        </div>
    </section>
