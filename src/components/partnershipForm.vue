            ...
            <form @submit="submitForm">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input v-model="form.company" type="text" name="oraganization" id="oraganization" class="input focus:ring-orange-600 focus:border-orange-600" placeholder="Organization/Company name" required="">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select v-model="form.interest" required class="input bg-gray-800 focus:ring-orange-500 focus:border-orange-500">
                            <option disabled value="">Select Partnership Interest</option>
                            <option value="reseller">Reseller or Referral Partner</option>
                            <option value="joint_devt">Joint Product Development</option>
                            <option value="tech_infrastructure">Technology & Infrastructure</option>
                            <option value="training">Educational / Training Collaboration</option>
                            <option value="marketing">Media / Marketing Partnership</option>
                            <option value="other">Other (Specify below)</option>
                        </select>
                    </div>
                    <div class="sm:col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                        <textarea v-model="form.message" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="Tell us more about your parnership idea..."></textarea>                    
                    </div>
                </div>
                <input v-model="form.website" type="url" placeholder="Website or Profile (optional)" class="input mb-4" />
