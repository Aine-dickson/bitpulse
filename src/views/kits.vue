    ...
    <div class="field">
        ...
        <section class="bg-paper">
            <div class="mx-auto max-w-[1000px] px-5 pb-9 pt-8 sm:px-8 sm:pb-12 sm:pt-12">
                ...
                <h1
                    class="mt-4 max-w-[18ch] text-[2rem] font-extrabold leading-[1.04] tracking-tight text-inkf xs:text-[2.3rem] sm:text-[3rem]">
        ...
        <section class="border-t border-rule bg-card">
            <div class="mx-auto max-w-[1000px] px-5 py-10 sm:px-8 sm:py-14">
                <div class="grid gap-4 sm:grid-cols-2">
                    <RouterLink v-for="k in kits" :key="k.slug" :to="`/kits/${k.slug}`"
        ...
        <section class="border-t border-rule bg-panel">
            <div class="mx-auto max-w-[1000px] px-5 py-11 sm:px-8 sm:py-14">
                <h2
                    class="max-w-[20ch] text-[1.5rem] font-extrabold leading-tight tracking-tight text-panel-ink sm:text-[2rem]">
